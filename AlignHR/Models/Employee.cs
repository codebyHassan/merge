...
namespace AlignHR.Models
{
    ...
    public class Employee :  IValidatableObject
    {
        ...
        [StringLength(50)]
        [Display(Name = "HR Business Partner Code")]
        public string? HRBPEmpNo { get; set; }
        ...
        [ForeignKey("GenderFk")]
        public Valueset? Gender { get; set; }

        public int? MaritalStatusFk { get; set; }
        [ForeignKey("MaritalStatusFk")]
        public Valueset? MaritalStatus { get; set; }

        public int? ReligionFk { get; set; }
        [ForeignKey("ReligionFk")]
        public Valueset? Religion { get; set; }

        public DateOnly? DateOfBirth { get; set; }

        [StringLength(15)]
        public string? CNIC { get; set; }
        public DateOnly? CNICIssueDate { get; set; }
        public DateOnly? CNICExpDate { get; set; }

        public int? CitizenshipFk { get; set; }
        [ForeignKey("CitizenshipFk")]
        public Valueset? Citizenship { get; set; }

        public int? NationalityFk { get; set; }
        [ForeignKey("NationalityFk")]
        public Valueset? Nationality { get; set; }

        public int? BloodGroupFk { get; set; }
        [ForeignKey("BloodGroupFk")]
        public Valueset? BloodGroup { get; set; }

        public int? DomicileFk { get; set; }
        [ForeignKey("DomicileFk")]
        public Valueset? Domicile { get; set; }
        ...
        [ForeignKey("BranchFk")]
        public Valueset? Branch { get; set; }

        public int? FunctionFk { get; set; }
        [ForeignKey("FunctionFk")]
        public Valueset? EmpFunction { get; set; }

        public int? GroupFk { get; set; }
        [ForeignKey("GroupFk")]
        public Valueset? EmpGroup { get; set; }

        public int? CityFk { get; set; }
        [ForeignKey("CityFk")]
        public Valueset? City { get; set; }

        public int? CountryFk { get; set; }
        [ForeignKey("CountryFk")]
        public Valueset? Country { get; set; }

        public int? CostCenterFk { get; set; }
        [ForeignKey("CostCenterFk")]
        public Valueset? CostCenter { get; set; }
        ...
        // ── Benefits ─────────────────────────────────────────────────────────
        public bool IsPFProfit { get; set; } = false;

        // ── Banking & Govt ────────────────────────────────────────────────────
        public string? PessiRegNo { get; set; }
