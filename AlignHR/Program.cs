...
// Register HttpClient for external API proxying (dropdown controller)
builder.Services.AddHttpClient("DropdownApi", client =>
{
    client.Timeout = TimeSpan.FromSeconds(10);
    client.DefaultRequestHeaders.Add("User-Agent", "AlignHR/1.0");
});
...
// Register Document approval workflow engine
...
// Ensure decimal values like "10.00" always parse correctly regardless of server OS culture
...
// Map attribute-routed controllers (API controllers like PublicDropdownController)
app.MapControllers();
