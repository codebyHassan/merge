...
namespace AlignHR.Controllers
{
    public class DashboardController : BaseController
    {
        ...
        public IActionResult Index()
        {
            ...
            if (myEmpId.HasValue && HasAccess(session, "PayrollRegister", "Payroll", "PayRollGenrate"))
            {
                try
                {
        ...
        private static List<QuickAction> BuildQuickActions(UserSession? session)
        {
            var candidates = new List<QuickAction>
            {
                ...
                new() { Label = "Payroll Register", Icon = "bi-cash-stack", Controller = "PayrollRegister", Action = "Index" },
